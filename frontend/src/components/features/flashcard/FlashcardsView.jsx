            ...
            <div className={styles.headerSection}>
                ...
                {showFilters && (
                    <div className={styles.filtersRow}>
                        ...
                        <select
                            id="flashcards-filter-source-mobile"
                            name="filterSource"
                            value={filterSource}
                            onChange={(e) => setFilterSource(e.target.value)}
                            className={styles.filterSelect}
